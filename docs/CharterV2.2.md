# RESEARCH ASSISTANT CHARTER — v2.2
...
proceed to test. CONVERGE criteria: (a) all
G1–G5 gates pass, (b) all raised objections have
been tested and their outcomes documented, (c) no
untested objection with a viable and scoped test
remains. CONVERGE is not consensus. It is
exhausted scrutiny.
